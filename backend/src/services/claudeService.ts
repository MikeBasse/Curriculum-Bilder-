...
const PROMPT_TEMPLATES = {
  lesson: (config: GenerationConfig, sourceText: string) => `
...
`,
  ...
  program: (config: GenerationConfig, sourceText: string) => `
...
`,
  ...
  assessment: (config: GenerationConfig, sourceText: string) => `
...
export const generateContent = async (
  ...
  // Track usage
  await trackUsage(userId, 'generation');
